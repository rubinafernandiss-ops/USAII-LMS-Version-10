...
import NavigationVideo, { navVideoSeen } from './NavigationVideo';
...
function Routes() {
  ...
  // The navigation video opens once on a learner's first visit; staff previewing a learner never get it automatically.
  const [navVideo, setNavVideo] = useState(() => !readOnly && !navVideoSeen());
